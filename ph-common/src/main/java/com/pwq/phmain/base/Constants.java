...
public class Constants {
    ...
    //验证码类型
    public final static String VALIDATE_TYPE_CODE_SMS = "短信";//验证码-短信
    public final static String VALIDATE_TYPE_CODE_IMG = "图片";//验证码-图片
    ...
    public final static String ZERO_ZERO    = "00";
     ...
     * 超时时间
     */
    public final static int ENQUEUE_TIME_OUT = 300;//入队过期时间
